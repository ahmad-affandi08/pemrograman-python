...
def agent_jawab(input_pengguna: str) -> str:
    teks = input_pengguna.lower().strip()

    if "hitung" in teks:
        ekspresi = teks.replace("hitung", "").strip()
        hasil = kalkulator(ekspresi)
...
if __name__ == "__main__":
    ...
    print("=== AGENT DENGAN MEMORI ===")
    print("Ketik 'ringkas chat' untuk melihat percakapan terakhir")
    print("Memori akan tersimpan otomatis saat keluar")
